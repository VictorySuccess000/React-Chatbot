    ...
    <>
      <StyledAgent>
        ...
        <FlexLayout
          ...
          wrap="nowrap"
        >
          <Text fontSize="32px" opacity="1" padding="0 0 0 10px">
            Agent Chat Details
          </Text>
          <FlexLayout
            display="grid"
        ...
        >
          ...
          >
            ...
            >
              <FlexLayout>
                <FlexLayout padding="19px 18px 0 18px" width="100%">
                  <AgentDetail data={agentdata} />
                </FlexLayout>
                <FlexLayout justify="flex-start" padding="0 13px 0 13px">
                  <FlexLayout
                    margin="20px 0 0 0"
                    justify="space-between"
                    backgroundColor="white"
              ...
              {slide ? (
                ...
                >
                  <FlexLayout
                    ...
                    align="flex-start"
                  >
                    <FlexLayout margin="27.62px 0 0 0" justify="flex-start">
                    ...
                    <FlexLayout margin="27.62px 0 0 0">
                      <Text color="#202945" fontSize="16px">
                        3. Chat Comments
                      </Text>
                    </FlexLayout>
                    ...
                    >
                      ...
                      >
                        <FlexLayout width="100%">
                          <TextArea placeholder="HI this is Amit goyani 😊"></TextArea>
                        </FlexLayout>
                      </FlexLayout>
                      <FlexLayout width="100%" height="19px">
                        <Button
      ...
      <CustomModal visible={visible} setVisible={onClickModal}>
